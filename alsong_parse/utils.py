...
class Utils:
    ...
    @classmethod
    def search_xml(cls, info: dict) -> str:
        """
    ...
    @classmethod
    def search_with_mp3_xml(cls, filename: str) -> str:
        """
        ...
        파라미터
            ...
            artist: 검색할 노래의 아티스트
        """
        hashes = cls.create_mp3_hash(filename)
        enc_data = cls.create_enc_data()
        xml = XML_WITH_MP3_TEMPLATE.format(hash=hashes, enc_data=enc_data)
        return xml.strip()

    @classmethod
    def create_mp3_hash(cls, filename: str) -> str:
        """
    ...
    @classmethod
    def get_info(cls, filename: str) -> Dict[str, Union[str, int]]:
        """
